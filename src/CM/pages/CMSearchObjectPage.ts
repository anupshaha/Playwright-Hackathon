...
export default class CMSearchObjectPage{
    ...
    private keyword_to_search : Locator;
    ...
    constructor(page: Page) {
        ...
        this.keyword_to_search = page.getByRole(`textbox`, { name: `Enter search keywords` });
    ...
    public async searchObject(object : string, search_keyword : string){
        /* This method is used to search the object like API, APP,Ticket,Comments,Documents etc.
        Object - type of object you want to search, i.e. is API
        search_keyword - object name to search, i.e. swagger_petstore
        ...
        */
        ...
        await this.keyword_to_search.click();
        await this.keyword_to_search.type(search_keyword,{delay:100});
